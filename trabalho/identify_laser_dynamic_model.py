...
def main():
    ...
    parser.add_argument(
        "--ref", default="ref_dec_trimmed.csv", help="Path to reference trajectory CSV (x,y,theta)"
    )
    parser.add_argument(
        "--laser", default="laser_dec_trimmed.csv", help="Path to laser CSV (time x beams)"
    )
    parser.add_argument(
