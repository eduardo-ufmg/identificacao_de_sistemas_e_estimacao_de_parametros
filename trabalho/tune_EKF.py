...
from EKF import EKFEstimator, build_odometry_trajectory, load_laser_data
...
def main():
    parser = argparse.ArgumentParser(description="Tune EKF parameters via optimization")
    parser.add_argument(
        "--odo-diff",
    ...
    parser.add_argument(
        "--output", default="ekf_tuned.json", help="Path to save tuned parameters"
    )
    parser.add_argument(
    ...
    if args.ground_truth:
        ...
        print("Error: --ground-truth argument is required for EKF tuning.")
