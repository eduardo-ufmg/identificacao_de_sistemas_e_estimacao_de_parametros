...
SEARCH_SPACES = {
    'PF': [
        Real(0.001, 2.0, name='motion_noise_x'),
        Real(0.001, 2.0, name='motion_noise_y'),
        Real(0.001, 2.0, name='motion_noise_theta'),
        Real(0.001, 2.0, name='laser_noise_std'),
        Real(0.1, 1.0, name='resample_threshold')
    ],
    'EKF': [
        Real(0.001, 2.0, name='Q_x'),
        Real(0.001, 2.0, name='Q_y'),
        Real(0.001, 2.0, name='Q_theta'),
        Real(0.001, 2.0, name='R_laser'),
        Integer(1, 100, name='laser_beam_skip')
    ],
    'UKF': [
        Real(1e-6, 1.0, name='alpha'),
...
def run_all_tuning():
    ...
    for filter_name in ['PF', 'EKF', 'UKF']:
        ...
        tuning_result = tuner.tune(n_iterations=20)
